...
public class User 
{
  ...
  {
    User other2 = (User) other;     // type casts object other to class User

    if (!(this.name.equals(other2.getName())))    // compares name
    {
      return false;
    }

    if (!(this.address.equals(other2.getAddress())))    // compares address
    {
      return false;
    }
